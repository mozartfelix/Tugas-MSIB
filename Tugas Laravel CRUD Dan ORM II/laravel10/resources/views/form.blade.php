    ...
    <form action="{{ route('post_form') }}" method="POST">
        ...
        <div class="mx-auto my-lg-3" style="width: 400px;">
            <div class="rounded bg-info pt-2 pb-3">
                <h5 class="text-center fw-bold mt-2">Tambah Data Produk</h5>
                <div class="mx-3 mb-3">
                ...
                <div class="mx-3 mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" placeholder="Tuliskan deskripsi produk yang akan dijual" id="" cols="30" rows="3"></textarea>
                </div>
